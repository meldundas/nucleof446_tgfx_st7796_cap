...
struct Typography
{
    ...
    static const touchgfx::FontId ORBITRON = 3;
    static const touchgfx::FontId SEVENSEG = 4;
    static const touchgfx::FontId SEVENSEG30 = 5;
};
...
struct TypographyFontIndex
{
    ...
    static const touchgfx::FontId ORBITRON = 3;   // Orbitron_Regular_40_4bpp
    static const touchgfx::FontId SEVENSEG = 4;   // SevenSegment_20_4bpp
    static const touchgfx::FontId SEVENSEG30 = 5; // SevenSegment_30_4bpp
